...
public class _04_JavaArrayMetodlar {
    public static void main(String[] args) {
        ...
        // diziler eşit mi? Arrays.equls(dizi1,dizi2)
        int[] a={1,8,3,54};
        int[] b={1,8,3,54};
        int[] c={1,8,3,96};
        ...
        // bütün kutucuklara 7 atar.
        Arrays.fill(c,7);
        System.out.println("c = " + Arrays.toString(c));

        //Arrays.binarySearch(rakamlar,5)  -> Sıralı dizide aranan elamnın indexini verir.
        ...
        int[] rakamlar={2,7,4,6,23,3,5,6,89};
